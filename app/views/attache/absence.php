   <!-- Filtres -->
   <div class="bg-gray-50 shadow p-4 flex justify-between items-center rounded-bl-xl rounded-tr-xl">
       <h2 class="text-xl font-semibold">Liste des Absences</h2>
       <form id="filterForm" method="get" class="flex items-center space-x-4">
           <input type="hidden" name="controller" value="absence">
   ...
   <?php if ($absence != null): ?>
       <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 p-6">
           <?php foreach ($absence as $value): ?>
               <div class="bg-gray-50 border rounded-lg flex-col shadow-md p-4 hover:shadow-lg transition">
